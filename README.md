...
<p align="center">
  ...
  <a href="https://github.com/JustMLC4real/LLMelt/actions/workflows/ci.yml"><img alt="CI" src="https://img.shields.io/github/actions/workflow/status/JustMLC4real/LLMelt/ci.yml?branch=main&style=flat-square&label=tests"></a>
...
Start a conversation, pick the exact provider and model you want, and keep the prompt, tool activity and answer together. This is a real automated recording of LLMelt: the cursor clicks through the live model picker, types the prompt and waits while **Claude Opus 4.6 through Antigravity CLI** answers.
...
- No license has been granted unless a license file is added to the repository.
